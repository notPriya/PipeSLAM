...
%
% July 2008  - Original version. (HomoNormDLT)
% May  2011  - Updated

function H = computeH_norm(x1, x2)

% Swap roles of x1 and x2
x1t = x1;
x1 = x2;
x2 = x1t;
...
if averagedist1<0.01 || averagedist2<0.01 || any(isnan([scale1,scale2])) || any(isinf([scale1,scale2]))
    H = eye(3);
    return;
end
